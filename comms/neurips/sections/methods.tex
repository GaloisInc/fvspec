...
\begin{figure}[t]
  ...
  (c)~Histogram of the number of direct local function calls per PBT.}\vspace{-0.5em}
...
\begin{figure}[t]
  ...
  \caption{Structural-faithfulness scores across the published \FVSpec:FV
    ...
    of the same PBT are available.}\vspace{-0.5em}
...
grades the output; 11{,}039 PBTs enter and 9{,}415 FVCs (from 2{,}772 distinct PBTs) emerge.}\vspace{-0.5em}
\label{fig:pipeline}
\end{figure}
