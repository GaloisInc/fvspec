...
\emph{License-detection edge cases.} Our scraper (\Secr{dataset}) skips repositories with explicitly non-permissive licenses but accepts repositories where GitHub cannot detect a license at all. 
