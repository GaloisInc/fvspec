...
Figure~\ref{fig:python_source} summarizes two code-quality metrics across the corpus.
...
\begin{figure}[t]
  ...
  \emph{Right}: cyclomatic complexity---the number of linearly independent execution paths through the function, i.e.\ one plus the number of binary branch points~\cite{mccabe1976complexity}; higher values indicate more complex control flow.}
