...
First, we scrape $\approx$20k PBTs written in Python's Hypothesis framework~\cite{maciver2019hypothesis}. 
...
We characterize our input corpus, detailing how we scraped and deduplicated $\approx$20k Hypothesis tests from open-source repositories, in \Secr{dataset},
