...
\Secl{related}
Our work extends FVAPPS by Dougherty and Mehta \cite{dougherty2025proving}, which established AI-driven translation of coding problems into Lean theorems. In FVAPPS, source programs were taken from the APPS benchmark \cite{hendrycks2021apps}, translated to PBTs, then lifted to theorems. We apply the same process at scale to PBTs found in the wild, inferring specifications from natural language and source code. 
