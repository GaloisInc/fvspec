...
def get_indicators(dir_list: list[str], styles) -> panel.FlexBox:
    """Render the headline indicators shown above the plots.

    It is refreshed whenever the directory list changes.

    Parameters:
        dir_list: The benchmark run directories selected by the user.
        styles: The default panel styles applied to indicator widgets.

    Returns:
        A `panel.FlexBox` with counts of datapoint JSON files and Lean specs.
    """
