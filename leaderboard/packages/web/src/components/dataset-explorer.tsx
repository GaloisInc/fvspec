...
export function DatasetExplorer({ initialSample }: DatasetExplorerProps) {
    ...
    return (
        <div className="space-y-6">
            ...
            <Alert>
                <AlertDescription>
                    <strong>Early Development Dataset:</strong> This preview contains 322 samples
                    while we work out generation pipeline kinks. The final benchmark will be{' '}
                    <strong>2+ orders of magnitude larger</strong> with significantly improved
                    specification quality. Current samples are experimental and may contain
            ...
            <Card>
                <CardHeader>
                    ...
                    {initialSample.summary && (
                        <CardDescription>{initialSample.summary}</CardDescription>
                    )}
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="flex flex-wrap gap-2">
                        ...
                        {initialSample.model && (
                            <Badge variant="secondary">Model: {initialSample.model}</Badge>
                        )}
