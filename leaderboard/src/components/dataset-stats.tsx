...
export function DatasetStats({ stats }: DatasetStatsProps) {
    return (
        <div className="space-y-6">
            ...
            <Alert>
                <AlertDescription>
                    <strong>Early Development Dataset:</strong> This preview contains {stats.total}{' '}
                    samples while we work out generation pipeline kinks.
                </AlertDescription>
            </Alert>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold">
                            {formatNumber(stats.theorems.mean)}
                        </div>
                        <p className="mt-1 text-xs text-muted-foreground">
                            Avg theorems per sample
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold">
                            {formatNumber(stats.lean_lines.mean)}
                        </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Quartiles (Q1, Median, Q3) and ranges for key metrics
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                        ...
                        <TableBody>
                            <TableRow>
                                ...
                                <TableCell className="text-right">
                                    {formatNumber(stats.faithfulness.min)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatNumber(stats.faithfulness.q1)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatNumber(stats.faithfulness.median)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatNumber(stats.faithfulness.q3)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatNumber(stats.faithfulness.max)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatNumber(stats.faithfulness.mean)}
                                </TableCell>
                            ...
                            <TableRow>
                                ...
                                <TableCell className="text-right">
                                    {formatInteger(stats.theorems.min)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatInteger(stats.theorems.q1)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatInteger(stats.theorems.median)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatInteger(stats.theorems.q3)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatInteger(stats.theorems.max)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatNumber(stats.theorems.mean)}
                                </TableCell>
                            ...
                            <TableRow>
                                ...
                                <TableCell className="text-right">
                                    {formatInteger(stats.lean_lines.min)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatInteger(stats.lean_lines.q1)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatInteger(stats.lean_lines.median)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatInteger(stats.lean_lines.q3)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatInteger(stats.lean_lines.max)}
                                </TableCell>
                                <TableCell className="text-right">
                                    {formatNumber(stats.lean_lines.mean)}
                                </TableCell>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Browse the dataset to see Python property-based tests and their generated
                        Lean specifications
                    </CardDescription>
                </CardHeader>
                <CardContent>
