...
def extract_pbts_with_context(directory: str) -> List[Tuple[str, List[str], str, List[str], List[str]]]:
    ...
    for pbts, deps in pbt_deps.items():
        try:
            full_pbt_deps.append((
                ...
                [functions[dep] for dep in deps],function_files[pbts]
            ))
        except Exception as e:
